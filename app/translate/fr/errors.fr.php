...
case PHONE = 'Ce champ %s doit étre un numéro valide requis';
}




enum FrErreurMessager: string
{
    case REQUIRE = 'Le champ %s est requis';
    case EMAIL = 'Le champ %s doit être une adresse email valide';
    case MIN = 'Le champ %s doit contenir au moins %s caractères';
    case MAX = 'Le champ %s doit contenir au maximum %s caractères';
    case NUMERIC = 'Le champ %s doit être un nombre';
    case ALPHA = 'Le champ %s ne doit contenir que des lettres';
    case ALPHANUM = 'Le champ %s ne doit contenir que des lettres et chiffres';
    case MATCH = 'Le champ %s doit correspondre au champ %s';
    case UNIQUE = 'Le champ %s est déjà utilisé';
    case DATE = 'Le champ %s doit être une date valide';
    case BOOLEAN = 'Le champ %s doit être vrai ou faux';
    case CONFIRMED = 'Le champ %s doit être confirmé';
}

// //exemple d'utilisation 
// $field = 'email';
// echo sprintf(FrErreurMessager::REQUIRE->value, $field);
// // Résultat : "Le champ email est requis"

// echo sprintf(FrErreurMessager::MIN->value, 'mot de passe', 8);
